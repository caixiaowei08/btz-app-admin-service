...
public enum QuestionType {
    ...
    Q3(3, "不定项选择题", "每小题有一个或一个以上正确答案，请从每小题的备选答案中选出你认为正确的答案。", 6, 4),
    Q4(4, "判断题", "每小题只有一个正确答案，请从每小题的备选答案中选出一个你认为正确的答案。", 3, 1),
    ...
    Q11(11, "补全短文", "每小题只有一个正确答案，请从每小题的备选答案中选出一个你认为正确的答案。", 4, 1),
    Q12(12, "概括大意与完成句子", "每小题只有一个正确答案，请从每小题的备选答案中选出一个你认为正确的答案。", 7, 3),
    Q13(13, "完型填空", "每小题只有一个正确答案，请从每小题的备选答案中选出一个你认为正确的答案。", 6, 4),
    Q14(14, "阅读理解", "每小题只有一个正确答案，请从每小题的备选答案中选出一个你认为正确的答案。", 6, 4),
    Q15(15, "阅读判断", "每小题只有一个正确答案，请从每小题的备选答案中选出一个你认为正确的答案。", 3, 1),
    Q16(16, "作文题", "请在下方的方框内输入你认为正确的答案。", 8, 2),
